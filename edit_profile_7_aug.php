        ...
        <div class="rows">
         <div class="col-01" <? if($err13 == 1)?>> <?=$parObj->_getLabenames($arrayDataEditProfile,'myImage','name');?> </div>
          <div class="col-02"><span><input name="user_photo" type="file" class="filefieldEdit" />
				  ...
				  <a href="javascript:void(0)" class="bold" onClick="openNewWindow('./uploads/users/<?=$currentImage?>','windowname',<?=($imageDetails[0]+100);?>,<?=($imageDetails[1]+50);?>)">View</a>
				  <? }?></span>
					  <? if($err13 == 1){ ?><span class="errorMessageCommonEP" onMouseOver="tooltip('<?=$photo?>');" onMouseOut="exit();">[?]</span><? }?><div>
...
$("#uploadForm").on('submit',(function(e){ alert("hereee");return false;
e.preventDefault();
$.ajax({
url: "upload.php",
type: "POST",

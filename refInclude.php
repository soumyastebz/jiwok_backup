...
#fbPostBtnId{border:none; color: #fff;font-family: 'Open Sans', sans-serif; font-weight: bold;}
.fblpopup{width: 100%; float: left;}	
/******/
...
<div class="pop_fb_popup" id="fbPostPopup" style="display:none;position:fixed;z-index:100000;">
   <div class="popbox_fb_popup">
       <a style="display:inline;" title="Fermer" onclick="javascript:disablePopupGeneral_fbPost('fbPostPopup','');" id="fancybox-close1" ></a>
...
<script type="text/javascript">
	...
	function disablePopupGeneral_fbPost(){
		$("#fbPostPopup").hide();
	}
	function fbPostNew(){
	...
	function setRefSts(fieldName){
		...
		xmlhttp.open("GET","http://10.0.0.8/jiwokv3/ajaxGetRefSts.php?fieldName="+fieldName,false);
		xmlhttp.send();

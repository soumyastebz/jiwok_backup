...
if(count($program)>0) 
	...
	{ echo"kk";
		...
		$last_used_program		= $objSort->getLastUsedProgram($userId);print_r($last_used_program);
		...
		if($last_used_program != '') 
			{ echo"11";
				...
				$matched_programs_from_db	= $objSort->_getWizardIds($userid,4,'',$lanId);echo"llppp";print_r($matched_programs_from_db);exit; 

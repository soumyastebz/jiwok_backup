   ...
   <div class="frame_inner">
    <div class="row-1"><div class="return">
        ...
        <li><a href="<?=ROOT_JWPATH?>userArea.php">
          <?=$parObj->_getLabenames($arrayData,'newMyAccTxt','name');?>
          </a></li>
        <li>></li>
        <li><a href="#" class="select">
          <?=$parObj->_getLabenames($arrayData,'newHstryTxt','name');?>
          </a></li> 
      ...
      <div class="title">
       ...
       <div class="panel-left">
          <section class="calender">
             <h3>  <?=$parObj->_getLabenames($arrayData,'pgmcalendar','name');?></h3>
         ...
         <section  id="commentSecDiv">
			 ...
			 <div style="float:right"> <a href="#" class="btn-orng">
			  <?=$parObj->_getLabenames($arrayData,'newOkTxt','name');?>
			  </a>
			  </div>
          </section>
       ...
       <div class="panel-rite" id="history_detail">
           <section class="session" id="produitLeftnew"> 
           </section>
       </div>
     </div>

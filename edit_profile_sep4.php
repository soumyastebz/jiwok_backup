  ...
  <div>
   ...
   <!----cropping code goes here-->
         ...
         <? if($currentImage=="" ){?>
			 ...
			 <img src="images/profile-dummy.png" alt="profile image"></figure><?}?>
<!--
         </form>
-->
         <!--crop-->
...
<!--
                /////
                 ...
                 <div class="rows">
                   <div class="col-01"><?=$parObj->_getLabenames($arrayData,'weight','name');?>*:  </div>
                   <div class="col-02">
                    <div class="split">
                   <input name="user_weight_value" type="text" class="tfl_small" value="<?=stripslashes($_POST[user_weight_value])?>"> 
                   </div>

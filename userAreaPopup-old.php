...
<?php } else if($userpaymentstatus == 0): ?>
<!--
<script type='text/javascript' src="includes/js/userArea.js"></script>
...
<div class="pop_Registrationmsg" id="Registrationmsg" style="display:none;position:fixed;z-index:100000;">
  ...
  <div class="popbox_Registrationmsg">
    <table width="100%" border="0" cellspacing="2" cellpadding="0" class="content">
      ...
      <tr>
        <td style="text-align:left"><?=$parObj->_getLabenames($arrayDataPopup,'mes21','name'); ?><?php if($lanId==5){?><a href="https://www.jiwok.com/pl/entrainement">plan treningowy</a>! <?php } ?><br/><br/></td>
      </tr>
      <tr>
        <td style="text-align:left"><?=$parObj->_getLabenames($arrayDataPopup,'mes2','name'); ?><?php if($lanId==5){?><a href="https://www.jiwok.com/pl/payment_renew.php">abonament</a><?php } ?><br/><br/></td>
<!--
        <td style="text-align:left"><?=$parObj->_getLabenames($arrayDataPopup,'mes2','name'); ?><?php if($lanId==5){?><a href="https://www.jiwok.com:443/pl/payment_renew.php">abonament</a><?php } ?><br/><br/></td>
-->
      </tr>
      <tr>
        <td align="center" style="text-align:left"><?=$parObj->_getLabenames($arrayDataPopup,'mes3','name'); ?><br/><br/></td>
      </tr>

...
$data['token']['id'] = 'tok_1AcXfoGOehFu6bSUT7DYPRj5';
$data['token']['email'] = 'peoniajunqueira@hotmail.com';
$data['amount'] = '1990';
$data['language_name'] = 'french';
$data['order_reference'] = 'MCwzLDEsMjA5MjE0LFBlb25pYSxwZW9uaWFqdW5xdWVpcmFAaG90bWFpbC5jb20sZW1wdHksZW1wdHksMCxnaWZ0LDIsSnVucXVlaXJhLEV1cm8sMA==';
...
if (base64_decode($data['order_reference'], true))
			...
			{
				$sessiondata	=	$data['order_reference'];
			}
...
/*$customer = \Stripe\Customer::create(array(
  ...
  $charge->paid = true;
  $customer->id = 'cus_AyUfCJn6HY80Zm';
  if($charge->paid == true)
 {
...
This user(".$user_name." ".$user_lname.") : with emailid :".$user_email." doing a payment gift code from ".$from_host.".The amount is:".$git_amount.$cur_lan." and the customer id is: ".$customer->id;
				...
				$codeQry = "SELECT max(code) as code FROM `gift_code` WHERE `codestatus` = 'unused' and codetype='$period'";
				$dat	=	$GLOBALS['db']->getRow($codeQry,DB_FETCHMODE_ASSOC);
				$code		=	count($dat);
				if($code>0)
				{
				 ...
				 // $query_retrv=mysql_query("select * from gift_member where purchaseid='$purchase_id'")or die(mysql_error());
				  ...
				  $query_retrv	=	"select * from gift_member where purchaseid='$purchase_id'";
				  $dat_rtev		=	$GLOBALS['db']->getRow($query_retrv,DB_FETCHMODE_ASSOC);
				  ...
				  //$replyto="info@jiwok.com";
					 if($gift_friend==0)
					 {
						...
						$query4="SELECT *
						 ...
						 if($language == 5)
						 {// for polsih url
						 		$message=str_replace("http://www.jiwok.com","<a  href='https://www.jiwok.com/pl/index.php'>https://www.jiwok.com</a>",$message);
						 }
						else
						{
							$message=str_replace("http://www.jiwok.com","<a  href='https://www.jiwok.com'>https://www.jiwok.com</a>",$message);
						}
						 ...
						 $messageattchmntto=str_replace("https://www.jiwok.com","<a href='https://www.jiwok.com'>https://www.jiwok.com</a>",$messageattchmntto);
					 ...
					 $content	= $GLOBALS['db']->getRow($query4,DB_FETCHMODE_ASSOC);
					 $message=nl2br($content['content_body'])."\n";
					 $message=str_replace("https://www.jiwok.com","<a href='https://www.jiwok.com'>https://www.jiwok.com</a>",$message);
				     $messageattchmnt=$content['template'];
					 ...
					 $messageattchmntslf=str_replace("https://www.jiwok.com","<a href='https://www.jiwok.com'>https://www.jiwok.com</a>",$messageattchmntslf);

...
foreach($optionMenus as $key => $data)
 ...
 3 boxes code-->
   ...
   <script type="text/javascript" src="<?=ROOT_JWPATH?>crop/assets/js/jquery.min.js"></script>
  <script type="text/javascript" src="<?=ROOT_JWPATH?>crop/assets/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="<?=ROOT_JWPATH?>crop/assets/js/cropper.min.js"></script>
   <script type="text/javascript" src="<?=ROOT_JWPATH?>crop/assets/js/canvas-to-blob.min.js"></script>
  <script type="text/javascript" src="<?=ROOT_JWPATH?>crop/assets/js/main.js"></script>

			...
			//echo "===========";	print_r($getTraining);echo "===========";
				...
				//HTML DATA TO BE DISPLAY ON PARENT PAGE
					...
					if($pgm_status=='4')
					  ...
					  //  print_r($getTraining['newprogramImage']); gg
                          ...
                          $image 			        = $objGen->_output(trim($getTraining['newprogramImage']));
						...
						$data	.=	'<figure>
						  ...
						  <img src="'.ROOT_FOLDER.$image.'" alt="'.$titlecat.htmlentities($altname).'">
						  </a>
                  </figure>';
...

	{
		...
		foreach($getAllTrainSubCats as $catData){
			...
			$data.='<div class="colums">
                <figure>
                  <img src="'.ROOT_FOLDER.'images/corner-4.png" alt="jiwok" class="corner">
                  <img src="'.ROOT_FOLDER.'images/dummy-2.jpg" alt="Jiwok">
                </figure>
                <article>';	
					
				 //~ $data.= '<h3>'.$cat_name_org.'</h3>';
                 $data.= ' <a href="'.$subCatUrl.'" ><p>'.$catData['category_name'].'</p></a>';
  ...
  "itemListElement": [{
    ...
    <div class="bred-hovr second">
		...
		?></a></li>
           ...
           <div class="bnr-image"><img src="<?=ROOT_FOLDER.$bannerimage?>" alt="jiwok"></div>
           <div class="bnr-content">
                <div class="inner">
                  <div class="heading3"><h1><?= $titlecat;?></h1></div> 

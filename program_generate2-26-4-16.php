...
<div class="callbacks_container">
      <ul class="rslides callbacks callbacks1" id="slider4">
       <?php
		 ...
		 ?>
        <li><img src="<?=ROOT_FOLDER?><?php echo $image;?>" alt="<?php echo $image;?>" style="z-index:0"></li>
      </ul>
    </div>
   ...
   <section class="chart">
    ...
    <section class="advice">
      ...
      <section id="workoutarea" class="seance_1 prgrm_gen_frame">

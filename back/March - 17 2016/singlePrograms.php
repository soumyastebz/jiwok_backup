...
$returnData		= $parObj->_getTagcontents($xmlPath,'searchWizard','label');
	...
	$data .= '<div class="bnr-content">
                <div class="inner">
				<div class="heading3"><p>'.mb_strtoupper($parObj->_getLabenames($arrayData,'single','name'),'UTF-8').'</p></div> 
	...
	//image list
		...
		$result.= '<article>';
		$result.= '<form>';
		$result.="<a href='".ROOT_JWPATH."program_generate2.php?program_id=".base64_encode($getAllTraining[$i]['program_id'])."'><p class=\"font-x\">".$pgm_title_org."</p></a>";
...
<section class="banner-static">
       <div class="bred-hovr second">
          <ul class="bredcrumbs">
           ...
           <div class="bnr-image"><img src="<?=ROOT_FOLDER?>images/banner_03.jpg" alt="jiwok"></div><?php echo $data; ?>

...
?>
    <div id="fb-root" ></div>
       ...
       <section class="pop" id="fbLoginPopup" >
            <div class="popbox">
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="0" >
		  ...
		  <tr>
           ...
           <input type="button"  onClick="getokid();" id="okid" name="renewSubscriptionIdBtn" class="btn_pop ease" value="<?php echo $popupYes; ?>">
          <input type="button" onClick="getcancelid();" id="cancelid" name="renewSubscriptionIdBtn" class="btn_pop ease" value="<?php echo $popupNo; ?>"></td>
		  </tr>
		</table>
         </div> </section>
       <!--pop up ends-->

...
$(document).ready(function(){
    $("#regForm").validate(
	{
	 ...
	 c_user_email: {
       required: "<br /><?=$parObj->_getLabenames($dataError,'emailerr','name');?>",
      // email: "<br /><?=$parObj->_getLabenames($dataError,'emailerr','name');?>"
     },
     password: {
       required: "<br /><?=$parObj->_getLabenames($dataError,'pass','name');?>",
      // email: "<br /><?=$parObj->_getLabenames($dataError,'emailerr','name');?>"
     }
   }
	}
    ...
    <div class="colum">
             <div class="fields">
                  <div <? if($registration->err1 == 1){ ?> class="rows error"<? }?>>
                     ...
                     <div class="colums"><input type="text" name="user_email" id="textfieldLtest1" class=" tfl required email " value="<?=stripslashes($_POST['user_email'])?>"></div>
                  ...
                  <div <? if($registration->pas1 == 1){ ?> class="rows error"<? }?>>
                     ...
                     <div class="colums"><input type="password" name="password" id="textfield3"  class="tfl required"  value="<?=$_POST['password']?>"></div>

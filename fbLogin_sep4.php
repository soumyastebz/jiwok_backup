    ...
    <div id="fb-root" ></div>
       ...
       <section class="pop" id="fbLoginPopup"> <img src="images/close.png" alt="close" class="close b-modal __b-popup1__">
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="0" >
		  <tr>
			<td align="center"> <div class="label_check"><?php echo $popupMsg; ?></div></td>
		  </tr>
		  <tr>
			<td align="center">

           <input type="button"  onClick="getokid();" id="okid" name="renewSubscriptionIdBtn" value="<?php echo $popupYes; ?>">
          <input type="button" id="cancelid" name="renewSubscriptionIdBtn" value="<?php echo $popupNo; ?>"></td>
		  </tr>
		</table>
         </div> </section>
       <!--pop up ends-->
  	  ...
  	  function commonAjax(url,params,resultAction){ 
			...
			xmlhttp.onreadystatechange=function(){ 
  				if (xmlhttp.readyState==4 && xmlhttp.status==200){
    				resTxt=xmlhttp.responseText; //ealert(resTxt);

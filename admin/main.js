...
$(selectorId).cropper('getCroppedCanvas').toBlob(function (blob) { 
 ...
 reader.onloadend = function() {
  ...
  $.ajax('uploader.php', {
    method: "POST",
    data: {'imageBlob': imageBlob, 'imageWidth': item.width, 'dbimage': dbimage,'imageHeight': item.height, 'imageName': imageName,'crop_user_id':crop_user_id},
    async: false,
    success: function (response) { 
		  window.location.href = "http://beta.jiwok.com/admin/program_img.php?langId="+langId;

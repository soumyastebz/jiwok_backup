...
-->
        ...
        <? }?>
<!--
       <a href="#"  id="SubmitDiv" onclick="loadSubmitResults();">Crop</a>
-->

<!--
 <iframe src='crop/crop.php?image=<? echo $currentImage?>&userId=<?php echo $userId?>' width='100%' height='500px'></iframe>
-->
  <input type="hidden" name="image" id="image" value="<?php echo $currentImage; ?>">
              <input type="hidden" name="userId" id="userId" value="<?php echo $userId; ?>">
 <button type="button" id="buttn" onclick="loadSubmitResults()" name="reexpedition" value = "View More" 
 >Crop </button>

<!--
<a href="#" onclick="popupCenter('crop.php?person_id=<?php echo $row['person_id']; ?>')">DELETE</a>
-->

<a href="#" onclick="popupCenter('crop/crop.php?image=<?php echo $currentImage; ?>&userId=<?php echo $userId; ?>')">DELETE</a>
...
-->
 ...
 var i 	= 	jQuery.noConflict();
 		   ...
 		   var image=i("#image").val(); 
 		     var userId=i("#userId").val(); 
  window.location ='crop/crop.php?image='+image+'&userId='+userId;
 
		  //alert(key);
		 //  window.location ='reexpedition.php?actionvar=Search&limit='+10+'&options='+1+'&mailbox='+key;
		// return false;
  }
    <!--pop up-->

function popupCenter(pageURL, title, w, h) { alert("here");return false;

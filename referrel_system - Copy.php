...
-->
              ...
              <div class="share">
                <div class="lft" >
                 <span <?php if($isNewPaybox){?>class="sharing"<?php }else{?>id="disSharing"<?php } ?>>
							<?php if($isNewPaybox){?> <a href="javascript:<?if(USER_STATUS	== "Allowed"){?>fb_login()<?}?>;"> <?php } ?>
 	...
 	<span id="fbChkCntr"><input name="fbChkBx"  id="checkbox-03"  value="fbchked" <?php echo $fbSts; ?><?php if(!$isNewPaybox){?>disabled="disabled" <?php } ?>  type="checkbox"></span> </label><span><?=$parObj->_getLabenames($arrayData,'refChkBthTxt','name');?></span>
	...
	<span id="twtChkCntr"> 
 <input name="twtChkBx" id="checkbox-04" value="twtchked" type="checkbox" <?php echo $twtSts; ?> <?php if(!$isNewPaybox){?>disabled="disabled" <?php } ?>></span> </label><span><?=$parObj->_getLabenames($arrayData,'refChkBthTxt','name');?> </span>

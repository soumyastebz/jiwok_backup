  ...
  <div class="container">
    ...
    <div class="tabResolutionsContent">
      ...
      foreach ($data as $item) {
        echo '
        <div id="tab-'.$tabId.'" class="tab-content crop-box '.$current.'" style="height: 500px; width: 60%;">
          <div class="row">
            <div class="col-lg-6 ">
...
<!--for crop-->
 <input type="text" name="crop_user_id" id="crop_user_id" value="<?php echo $crop_user_id; ?>">
	  <input type="text" name="imageToCrop" id="imageToCrop" value="<?php echo $imageName1[0]; ?>">
    <!--neethu-->
    <button  id="cropit" class="cropButton btn btn-danger">Crop All Images!</button>
</body>

...
<div class="callbacks_container">
        <ul class="rslides" id="slider4">
         ...
         <li>
           ...
           <a href="#" OnClick="location.href='<?=ROOT_JWPATH?>userreg1.php'" class="link"><?=$parObj->_getLabenames($arrayData,'newTopButtonTxt','name');?></a>
         </li>
         <?php }} ?>
       </ul>
    </div>
...
<!--------Testimonials open----------------------->
    <div class="grid_second frame mid-wrapper">
        ...
        <figure>
           ...
           <img src="<?=ROOT_FOLDER?>images/img-jiwok_01.jpg" alt="Jiwok">
        </figure>
...
<!--------Top search open-------------------------->
   <?php
    ...
    <?php
      ...
      <? //$topSrch[$j]['web_link'] = str_replace("http://www.jiwok.com/","beta.jiwok.com/",$topSrch[$j]['web_link']);?>

           <li>
             <div>
               <span class="count"><?php echo $topSrch[$j]['rank']; ?></span>
               <a href="<?php echo $topSrch[$j]['web_link'];  ?>"  ><span class="text"><h5><?php echo mb_strtoupper($topSrch[$j]['title'],'UTF-8'); ?></h5></span></a>
               </div>
               
<!--
               <div>
               <span class="count">5</span>
               <a href="http://www.jiwok.com/entrainement/Objectif+%3A+Courir+30+minutes+en+continu-10.3"><span class="text"><h5>DÉBUTER LE RUNNING DÉBUTER LE RUNNING </h5></span></a>
               </div>
               
                <div>
               <span class="count">5</span>
               <a href="http://www.jiwok.com/entrainement/Objectif+%3A+Courir+30+minutes+en+continu-10.3"><span class="text"><h3>DÉBUTER LE RUNNING </h3></span></a>
               </div>
-->
...
<!---------coaches slider closed----------------------->
    <section class="frame press mid-wrapper">
        ...
        <ul>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_01.jpg" alt="press"></span>
             <span class="count">8"</span>
           </li>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_02.jpg" alt="press"></span>
             <span class="count">15"</span>
           </li>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_03.jpg" alt="press"></span>
             <span class="count">19"</span>
           </li>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_04.jpg" alt="press"></span>
             <span class="count">32"</span>
           </li>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_05.jpg" alt="press"></span>
             <span class="count">1'19"</span>
           </li>
            <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_06.jpg" alt="press"></span>
        ...
        <ul>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_07.jpg" alt="press"></span>
             <span class="count">132m</span>
           </li>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_08.jpg" alt="press"></span>
             <span class="count">146m</span>
           </li>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_09.jpg" alt="press"></span>
             <span class="count">347m</span>
           </li>
           <li>
             <span class="press_ID"><img src="<?=ROOT_FOLDER?>images/press_10.jpg" alt="press"></span>
